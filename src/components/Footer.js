...
const Footer = () => {
  return (
    <footer className="flex flex-col bg-neutral-900 px-8 py-12 lg:flex-row">
      <section className="order-3 mx-auto my-4 flex flex-col gap-8 lg:order-1 lg:justify-between">
        <div className="order-2 mx-auto lg:order-1 lg:mx-0">
        ...
        <div className="order-1 lg:order-2 ">
          <ul className="flex w-full items-center gap-8 text-4xl">
      ...
      <section className="order-2 my-4 flex justify-around lg:order-2 lg:basis-2/4">
        <ul>
        ...
        <ul>
          ...
          <li className="footerLink">Community</li>
          <li className="footerLink">Privacy Policy</li>
        </ul>
      </section>
      <section className="order-1 mx-auto my-4 flex gap-2 lg:relative lg:order-3">
        <input
          type="text"
          className="h-12 w-64 rounded-full px-4 py-2"
          placeholder="Updates in your inbox.."
        />
        <button className="button h-12">Go</button>
        <p className="order-4 mx-auto my-4 hidden text-slate-300 lg:absolute lg:bottom-0 lg:right-0 lg:block">
          Copyright 2022. All Rights Reserved
        </p>
      </section>
      <p className="order-4 mx-auto my-4 text-slate-300 lg:hidden">
        Copyright 2022. All Rights Reserved
      </p>
    </footer>
  );
